...
from aplicacao.serializers import SerializerOTDDocenteEmCriacao
...
class TestSerializerOTDDocenteEmCriacao(TestCase):
    def setUp(self) -> None:
        self.serializer_class = SerializerOTDDocenteEmCriacao
